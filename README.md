...
Start by cloning it
```bash
git clone https://github.com/NHR-FAU-Training/introduction-to-openmp.git
```
...
[![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/NHR-FAU-Training/introduction-to-openmp/main?labpath=overview.ipynb)
\
